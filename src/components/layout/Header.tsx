...
import { LogOut, User, Shield, Users, Menu } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ onMenuToggle, showMenuButton = false }) => {
  ...
  const getUserDisplayName = () => {
    ...
    if (user?.email === 'vivek@gmail.com') return 'Admin';
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-3">
            ...
            >
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold text-gray-900">JANTA</h1>
